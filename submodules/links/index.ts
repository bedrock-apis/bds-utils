export const SERVICES_LATEST_DOWNLOAD_LINK: string =
   'https://net-secondary.web.minecraft-services.net/api/v1.0/download/links';
export const OSS_GIT_VERSIONS_ROOT: string =
   'https://raw.githubusercontent.com/Bedrock-OSS/BDS-Versions/main';
